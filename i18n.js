...
(function () {
    ...
    var I18N = {
        en: {
            ...
            "store.cancel": "Cancel",
            "store.payLaunching": "Razorpay Standard Checkout is active and ready for secure payment.",
            ...
            /* ---- Hanja Grimoire module ---- */
            "grimoire.title": "Hanja Grimoire",
            "grimoire.welcome.1": "Welcome back.",
            "grimoire.welcome.2": "The diary remembers you.",
            "grimoire.welcome.3": "Another page awaits.",
            "grimoire.welcome.4": "You returned. The pages stir.",
            "grimoire.welcome.5": "Years, and still you return. Good.",
            "grimoire.subtitle": "Learn Hanja. Stroke by stroke, the eye judges your hand.",
            "grimoire.enter": "Open the Diary",
            "grimoire.awaken": "The diary awakens…",
            "grimoire.progress": "Progress",
            "grimoire.streak": "Day Streak",
            "grimoire.lesson": "Current Lesson",
            "grimoire.lessonName": "The Four Friends",
            "grimoire.voice": "Voice Mode",
            "grimoire.type": "Type Mode",
            "grimoire.voiceHint": "Speak to the Grimoire — it is listening.",
            "grimoire.typeHint": "Write to the Grimoire in ancient script.",
            "grimoire.listen": "Listening…",
            "grimoire.typePlaceholder": "Offer your words to the Grimoire…",
            "grimoire.send": "Inscribe",
            "grimoire.drawTitle": "Practice Writing Hanja",
            "grimoire.undo": "Undo",
            "grimoire.clear": "Clear",
            "grimoire.replay": "Replay Stroke",
            "grimoire.check": "Check Writing",
            "grimoire.checkHint": "The spirit studies your hand. (coming soon)",
            "grimoire.lessonCard.char": "Character",
            "grimoire.lessonCard.meaning": "Meaning",
            "grimoire.lessonCard.reading": "Korean Reading",
            "grimoire.lessonCard.words": "Example Words",
            "grimoire.lessonCard.pron": "Pronunciation",
            "grimoire.lessonCard.sentence": "Example Sentence",
            "grimoire.modules": "Grimoire Pages",
            "grimoire.mod.learn": "Learn",
            "grimoire.mod.draw": "Draw",
            "grimoire.mod.quiz": "Quiz",
            "grimoire.mod.vocab": "Vocabulary",
            "grimoire.mod.daily": "Daily Challenge",
            "grimoire.mod.journal": "Journal",
            "grimoire.mod.achieve": "Achievements",
            "grimoire.mod.spirit": "Spirit Companion",
            "grimoire.mod.settings": "Settings",
            "grimoire.nav.voice": "Voice",
            "grimoire.nav.type": "Type",
            "grimoire.nav.draw": "Draw",
            "grimoire.nav.progress": "Progress",
            "grimoire.spirit.title": "Spirit Companion",
            "grimoire.spirit.line1": "I am bound to these pages, Scholar — but gladly so, for I love to teach.",
            "grimoire.spirit.line2": "Speak, and the ink will answer. Draw, and I will judge your hand.",
            "grimoire.spirit.line3": "We have walked this path together for {n} lessons. The library remembers every one.",
            "grimoire.settings.title": "Grimoire Settings",
            "grimoire.settings.particles": "Floating Dust",
            "grimoire.settings.pulse": "Heartbeat Pulse",
            "grimoire.settings.voice": "Voice Reply",
            "grimoire.settings.sound": "Sound (coming soon)",
            "grimoire.placeholder": "This page of the Grimoire is still being written. (coming soon)",
            "grimoire.voiceUnsupported": "Your device has no listening spirit. Try Type Mode.",

            /* Lesson engine + writing practice */
            "grimoire.lesson.show": "Show Stroke Order",
            "grimoire.lesson.animate": "Animate",
            "grimoire.lesson.guide": "Guide Me",
            "grimoire.lesson.theme": "Theme",
            "grimoire.lesson.next": "Next Lesson",
            "grimoire.writing.score": "The spirit studies your hand…",
            "grimoire.writing.excellent": "A flawless hand. The character lives.",
            "grimoire.writing.good": "Well formed. A little more care on the stroke order.",
            "grimoire.writing.tryagain": "The form is not yet right. Watch the animation and try again.",
            "grimoire.writing.missed": "Missing stroke: {n}.",
            "grimoire.writing.off": "Stroke {n} is a little off — {hint}",
            "grimoire.writing.loading": "Summoning the stroke data…",
            "grimoire.writing.nodata": "Stroke data for this character is not yet available offline.",
            "grimoire.voice.sending": "Listening to your words…",
            "grimoire.voice.speaking": "The spirit considers your words…",
            "grimoire.spirit.ask": "Ask the spirit",
            "grimoire.spirit.placeholder": "Speak to the spirit of the book…",
            "grimoire.spirit.send": "Speak",
            "grimoire.error.api": "The spirit is unreachable right now. (backend offline?)",
            "grimoire.error.stt": "The listening spirit could not hear you. (STT failed)",

            /* Book-gateway experience (Hanja Grimoire: object first, no dashboard) */
            "grimoire.scene.hint": "The book is closed. Touch it.",
            "grimoire.openHint": "The Grimoire awaits.",
            "grimoire.inkPrompt": "What shall we study today?",
            "grimoire.bookmark.learn": "Learn",
            "grimoire.bookmark.write": "Write",
            "grimoire.bookmark.archive": "Archive",
            "grimoire.bookmark.journey": "Journey",
            "grimoire.archive.title": "The Archive",
            "grimoire.archive.empty": "No pages have been filled yet.",
            "grimoire.journey.title": "Your Journey",
            "grimoire.chapter": "Chapter",
            "grimoire.meaning": "Meaning",
            "grimoire.reading": "Reading",
            "grimoire.words": "Words",
            "grimoire.drawTitle": "Draw below",
            "grimoire.drawHint": "Trace the character with the brush.",
            "grimoire.voiceHint": "Speak, and the ink will answer.",
            "grimoire.typeHint": "Write, and the book will read.",
            "grimoire.typePlaceholder": "Offer your words to the Grimoire…",
            "grimoire.send": "Inscribe",
            "grimoire.inkThinking": "The Grimoire considers…",
            "grimoire.idleFlip": "The Grimoire grows restless…"
        },
        ...
        ko: {
            ...
            "store.total": "합계",
            "store.payRazorpay": "Razorpay로 결제하기",
            "store.modalNote": "Razorpay를 통해 256비트 암호화로 안전하게 결제됩니다. UPI, 카드, 계좌이체, 간편결제를 지원합니다.",
            "store.cancel": "취소",
            "store.payLaunching": "Razorpay 표준 결제가 활성화되어 안전하게 결제할 수 있습니다.",
            ...
            /* ---- 한자 마법서 모듈 (Hanja Grimoire) ---- */
            "grimoire.title": "한자 마법서",
            "grimoire.welcome.1": "다시 오셨군요, 학자여.",
            "grimoire.welcome.2": "마법서는 그대를 기억하네.",
            "grimoire.welcome.3": "또 다른 수업이 기다리네.",
            "grimoire.welcome.4": "그대가 돌아오니 책장이 스르륵 움직이네.",
            "grimoire.welcome.5": "수백 년을 기다려도 그대는 다시 오네. 좋소.",
            "grimoire.subtitle": "가르침을 기다려 온 고대의 책.",
            "grimoire.enter": "마법서 열기",
            "grimoire.awaken": "마법서가 깨어나는 중…",
            "grimoire.progress": "진도",
            "grimoire.streak": "연속 출석",
            "grimoire.lesson": "현재 수업",
            "grimoire.lessonName": "네 친구",
            "grimoire.voice": "음성 모드",
            "grimoire.type": "필사 모드",
            "grimoire.voiceHint": "마법서에게 말하세요 — 지금 듣고 있네.",
            "grimoire.typeHint": "고대의 글자로 마법서에게 적으세요.",
            "grimoire.listen": "듣는 중…",
            "grimoire.typePlaceholder": "그대의 말을 마법서에 바치세요…",
            "grimoire.send": "새기기",
            "grimoire.drawTitle": "한자 쓰기 연습",
            "grimoire.undo": "되돌리기",
            "grimoire.clear": "비우기",
            "grimoire.replay": "획 다시 보기",
            "grimoire.check": "글씨 검사",
            "grimoire.checkHint": "정령이 그대의 손글씨를 살피네. (준비 중)",
            "grimoire.lessonCard.char": "글자",
            "grimoire.lessonCard.meaning": "뜻",
            "grimoire.lessonCard.reading": "한국어 읽기",
            "grimoire.lessonCard.words": "예문 단어",
            "grimoire.lessonCard.pron": "발음",
            "grimoire.lessonCard.sentence": "예문",
            "grimoire.modules": "마법서의 페이지",
            "grimoire.mod.learn": "배우기",
            "grimoire.mod.draw": "쓰기",
            "grimoire.mod.quiz": "퀴즈",
            "grimoire.mod.vocab": "어휘",
            "grimoire.mod.daily": "오늘의 과제",
            "grimoire.mod.journal": "일기",
            "grimoire.mod.achieve": "업적",
            "grimoire.mod.spirit": "정령 동료",
            "grimoire.mod.settings": "설정",
            "grimoire.nav.voice": "음성",
            "grimoire.nav.type": "필사",
            "grimoire.nav.draw": "쓰기",
            "grimoire.nav.progress": "진도",
            "grimoire.spirit.title": "정령 동료",
            "grimoire.spirit.line1": "나는 이 책장에 갇혔으나, 그대를 가르치기에 기꺼이 그러네.",
            "grimoire.spirit.line2": "말하라, 그러면 먹물이 답하리라. 쓰라, 그러면 그대의 손을 살피리라.",
            "grimoire.spirit.line3": "우리는 이 길을 {n}번이나 함께 걸었네. 도서관은 모두 기억하네.",
            "grimoire.settings.title": "마법서 설정",
            "grimoire.settings.particles": "떠다니는 먼지",
            "grimoire.settings.pulse": "심장 박동",
            "grimoire.settings.voice": "음성 답변",
            "grimoire.settings.sound": "소리 (준비 중)",
            "grimoire.placeholder": "이 마법서의 페이지는 아직 쓰이는 중이네. (준비 중)",
            "grimoire.voiceUnsupported": "그대의 장치엔 들을 정령이 없네. 필사 모드를 쓰세요.",

            /* Lesson engine + writing practice (ko) */
            "grimoire.lesson.show": "획순 보기",
            "grimoire.lesson.animate": "애니메이션",
            "grimoire.lesson.guide": "지도해 줘",
            "grimoire.lesson.theme": "주제",
            "grimoire.lesson.next": "다음 한자",
            "grimoire.writing.score": "정령이 그대의 손을 살피는 중…",
            "grimoire.writing.excellent": "흠잡을 데 없는 손길이네. 글자가 살아 숨 쉬는구나.",
            "grimoire.writing.good": "아주 잘 그렸네. 획순에 조금 더 신경 쓰면 좋겠네.",
            "grimoire.writing.tryagain": "형태가 아직 아니네. 애니메이션을 보고 다시 해보게.",
            "grimoire.writing.missed": "획이 빠졌네: {n}.",
            "grimoire.writing.off": "획 {n}이 조금 어긋났네 — {hint}",
            "grimoire.writing.loading": "획 데이터를 불러오는 중…",
            "grimoire.writing.nodata": "이 글자의 획 데이터는 오프라인에서 아직 없네.",
            "grimoire.voice.sending": "그대의 말을 듣는 중…",
            "grimoire.voice.speaking": "정령이 그대의 말을 음미하는 중…",
            "grimoire.spirit.ask": "정령에게 묻기",
            "grimoire.spirit.placeholder": "책의 정령에게 말을 걸어 보세요…",
            "grimoire.spirit.send": "말하기",
            "grimoire.error.api": "지금은 정령에 닿을 수 없네. (백엔드가 꺼져 있나?)",
            "grimoire.error.stt": "듣는 정령이 그대의 말을 알아듣지 못했네. (STT 실패)",

            /* 책-게이트 경험 (대시보드 없음) */
            "grimoire.scene.hint": "책은 닫혀 있네. 만져 보게.",
            "grimoire.openHint": "마법서가 기다리네.",
            "grimoire.inkPrompt": "오늘은 무엇을 배울까?",
            "grimoire.bookmark.learn": "배우기",
            "grimoire.bookmark.write": "쓰기",
            "grimoire.bookmark.archive": "보관",
            "grimoire.bookmark.journey": "여정",
            "grimoire.archive.title": "보관소",
            "grimoire.archive.empty": "아직 채워진 책장이 없네.",
            "grimoire.journey.title": "그대의 여정",
            "grimoire.chapter": "제",
            "grimoire.meaning": "뜻",
            "grimoire.reading": "읽기",
            "grimoire.words": "단어",
            "grimoire.drawTitle": "아래에 쓰게",
            "grimoire.drawHint": "붓으로 글자를 따라 그리게.",
            "grimoire.voiceHint": "말하라, 그러면 먹물이 답하리라.",
            "grimoire.typeHint": "적으라, 그러면 책이 읽으리라.",
            "grimoire.typePlaceholder": "그대의 말을 마법서에 바치세요…",
            "grimoire.send": "새기기",
            "grimoire.inkThinking": "마법서가 음미하는 중…",
            "grimoire.idleFlip": "마법서가 심심해하는구나…"
        }
    };
